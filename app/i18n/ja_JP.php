...
$radiumLocaleResources['ja_JP'] = array(
	...
	'Action "{1}" is not found. (Controller: {2})' => 'アクション {1} が見つかりません (コントローラ: {2})',
	'Model Class "{1}" is not found. ({2} at {2})' => 'モデルクラス {1} が見つかりません ({2}: {3}行目)',
	'Class file "{1}" is not found.' => 'クラスファイル {1} が見つかりません',
	'Method "{1}" cannot be called.' => 'メソッド {1} をコールできません',
	'Template "{1}" is not found.' => 'テンプレート {1} が見つかりません',
